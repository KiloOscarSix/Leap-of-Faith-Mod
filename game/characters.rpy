...
define an = Character("Anastasia - Apathetic Ice Queen", color="#fffc00")
...
define ls = Character("Lil' Sis", color="#f4c2c2")
define lb = Character("Lil' Bro", color="#89cff0")
define sa = Character("Samantha", color="#8aff33")
define va = Character("Vasquez", color="#8a9433")
define pm = Character("Paramedic", color="#ff5555")
